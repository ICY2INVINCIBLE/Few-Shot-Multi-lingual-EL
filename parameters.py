...
class Biencoder_params:
    def __init__(self):
        ...
        parser.add_argument('-dataset', action="store", default="dataset", dest="dataset", type=str)
        parser.add_argument('-srclang', action="store", default="en", type=str)
        parser.add_argument('-tgtlang', action="store", default="ja", type=str)
        ...
        parser.add_argument('-num_epochs', action="store", default=1, type=int)
        parser.add_argument('-batch_size', action="store", default=2, type=int)
        ...
        parser.add_argument('-bert_name', action='store', default='xlm-roberta-base', type=str)
        ...
        parser.add_argument('-vocab_size', action="store", default=300, type=int)
        ...
        parser.add_argument('--C_layers', type=int, default=2)
